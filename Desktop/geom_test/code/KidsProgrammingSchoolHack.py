...
class KidsProgrammingSchoolHack:  # 'Brand'には対象のブランド名をキャメルケースで入れてください
    BASE_URL = "https://8x9.jp/#school"
    ...
    def getStoreInfo(self):
        ...
        for html in html_contents:
            ...
            stores = soup.find('div',{'id':'school_detail'}).find_all('div',{'class':'tabbox'})
...
if __name__ == '__main__':
    try:
        ...
        df = KidsProgrammingSchoolHack(KidsProgrammingSchoolHack.BASE_URL).getStoreInfo()
    ...
    # df.to_csv('~/Desktop/geom_test/csv/KidsProgrammingSchoolHack.csv', index=True)
