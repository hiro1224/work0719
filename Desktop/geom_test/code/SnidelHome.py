...
class SnidelHome:  # 'Brand'には対象のブランド名をキャメルケースで入れてください
    BASE_URL = "https://snidel.com/snidel_home/Page/shoplist.aspx"
    ...
    def getStoreInfo(self):
        ...
        for html in html_contents:
            ...
            stores = soup.find('table',{'class':'shop_list'}).find_all('tr')
...
if __name__ == '__main__':
    try:
        ...
        df = SnidelHome(SnidelHome.BASE_URL).getStoreInfo()
    ...
    # df.to_csv('~/Desktop/geom_test/csv/SnidelHome.csv', index=True)
